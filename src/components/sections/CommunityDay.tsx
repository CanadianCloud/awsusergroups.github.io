...
export default function CommunityDay() {
  return (
    <section id="community-day" className="py-20 bg-gradient-to-b from-gray-50 to-white">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          {/* Image Grid */}
          <div className="flex-1 w-full">
            <div className="grid grid-cols-2 gap-4">
              <div className="h-52 md:h-56 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-shadow">
          ...
          <div className="flex-1 w-full space-y-6">
            ...
            <div className="pt-2">
              <button className="bg-aws-orange hover:bg-aws-orange-dark text-black font-semibold px-8 py-3.5 rounded-full transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 inline-flex items-center">
